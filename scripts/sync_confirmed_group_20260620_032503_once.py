#!/usr/bin/env python3
"""One-time sync for the confirmed battle_20260620_032503 config group.
...
- participants: country, level, grade, unit_type, initial_troops, redness,
  ...
  source_note, payload_json for the 4-report group.
- damage_contexts: source_context_json and target_context_json participant
  snapshots for the same heroes/reports.

Run when: after the user confirms this 4-report group uses the same tactics as
battle_20260620_024521 and provides the missing setup fields.
"""
...
REPORT_KEYS = (
    "battle_20260620_032503",
    "battle_20260620_040200",
    "battle_20260620_040920",
    "battle_20260620_042014",
)

SOURCE_NOTE = "用户于 2026-06-22 确认 battle_20260620_032503 同配置组"
