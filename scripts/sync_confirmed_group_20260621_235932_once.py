#!/usr/bin/env python3
"""One-time sync for the confirmed battle_20260621_235932 config group.

Source: user confirmation and screenshots in Codex thread on 2026-06-22.
Target tables/fields:
- participants: grade, innate_skill_redness, skills_text, tactics_text,
...
Run when: after the user confirms this 8-report group shares the same Huang
Zhong/Huang Yueying/Huang Gai/Da Qiao/Ma Chao configuration. This script is
intentionally scoped to those report keys and heroes.
"""
...
SOURCE_NOTE = "用户于 2026-06-22 确认 battle_20260621_235932 同配置组"
