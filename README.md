...
### 4. 剥离乘区后的基础项 Z 与出手时攻防差

将观测伤害逐层剥离所有已知乘区后，`Z = Base * (目标统率 + 160)` 与**出手时攻防差**呈清晰的对数线性关系，证实公式结构正确：

![Z vs 出手时攻防差](docs/physical_z_vs_setup_force_hp5000_no_machao_zongma_20260623.png)

### 5. 按武将*技能的误差热力图

![误差热力图](docs/forward_formula_hero_skill_error_heatmap_20260623.png)
